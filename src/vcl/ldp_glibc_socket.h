...
/* Send N bytes of BUF on socket FD to peer at address ADDR (which is
   ...
   This function is a cancellation point and therefore not marked with
   __THROW.  */
extern ssize_t sendto(int __fd, const void *__buf, size_t __n, int __flags, __CONST_SOCKADDR_ARG __addr,
...
/* Read N bytes into BUF through socket FD.
   ...
   This function is a cancellation point and therefore not marked with
   __THROW.  */
extern ssize_t recvfrom(int __fd, void *__restrict __buf, size_t __n, int __flags, __SOCKADDR_ARG __addr,
...
extern int __THROW getsockopt(int __fd, int __level, int __optname, void *__restrict __optval,
