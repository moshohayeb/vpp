...
test_lisp_msg_put_mreq()
{
    ...
    u8 expected_data[50] = {
        ...
        0xcc, 0xdd, 0xee, 0xff, 0x88, 0x99, 0xaa, 0xbb, 0x44, 0x55, 0x66, 0x77, 0x00, 0x11, 0x22,
...
build_test_map_records()
{
    ...
    locator_t loc = {.weight   = 1,
                     .priority = 2,
                     .local    = 1,
                     .address  = {.type   = GID_ADDR_IP_PREFIX,
                                 .ippref = {.addr = {.ip.v4.as_u32 = 0x99887766, .version = IP4}}}};
