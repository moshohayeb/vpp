...
test_locator_type(void)
{
    ...
    /* local locator */
    locator_t loc1,
        loc2 = {.local = 1, .state = 2, .sw_if_index = 8, .priority = 3, .weight = 100, .mpriority = 4, .mweight = 101};
...
test_src_dst_with_vni_serdes(void)
{
    ...
    fid_address_t src = {.type   = FID_ADDR_IP_PREF,
                         .ippref = {.len = 24, .addr = {.version = IP4, .ip.v4.data = {0x1, 0x2, 0x3, 0x0}}}};

    fid_address_t dst = {.type   = FID_ADDR_IP_PREF,
                         .ippref = {.len = 16, .addr = {.version = IP4, .ip.v4.data = {0x9, 0x8, 0x0, 0x0}}}};
