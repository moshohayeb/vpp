...
format_p2p_ethernet_trace(u8 *s, va_list *args)
{
    ...
    s                = format(s, "P2P ethernet: %U -> %U", format_vnet_sw_if_index_name, vnm, t->sw_if_index,
...
static uword
p2p_ethernet_input_node_fn(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame)
{
        ...
        while (n_left_from >= 4 && n_left_to_next >= 2) {
            ...
            if (rx0 != ~0) {
                ...
                if (PREDICT_FALSE(n_trace > 0)) {
                    ...
                    vlib_trace_buffer(vm, node, next_index, b0, 1 /* follow_chain */);
            ...
            if (rx1 != ~0) {
                ...
                if (PREDICT_FALSE(n_trace > 0)) {
                    ...
                    vlib_trace_buffer(vm, node, next_index, b1, 1 /* follow_chain */);
                    vlib_set_trace_count(vm, node, --n_trace);
...
VLIB_NODE_FUNCTION_MULTIARCH(p2p_ethernet_input_node, p2p_ethernet_input_node_fn)
/*
