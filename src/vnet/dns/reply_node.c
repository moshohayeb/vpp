...
static uword
dns46_reply_node_fn(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame)
{
      ...
      while (n_left_from >= 4 && n_left_to_next >= 2)
	{
	  ...
	  vlib_validate_buffer_enqueue_x2 (vm, node, next_index,
        ...
        while (n_left_from > 0 && n_left_to_next > 0) {
             ...
             */
            vlib_process_signal_event_mt(vm, dns_resolver_node.index, DNS_RESOLVER_EVENT_RESOLVED, (uword) resp0);
