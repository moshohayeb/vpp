...
static void
lisp_api_set_locator(vl_api_gpe_locator_t *loc, const ip_address_t *addr, u8 weight)
{
    loc->weight = weight;
...
static void
gpe_fwd_entries_copy(vl_api_gpe_fwd_entry_t *dst, lisp_api_gpe_fwd_entry_t *src)
{
...
static void
gpe_fwd_entries_get_reply_t_host_to_net(vl_api_gpe_fwd_entries_get_reply_t *mp)
{
    u32 i;
...
vl_api_gpe_add_del_fwd_entry_t_handler(vl_api_gpe_add_del_fwd_entry_t *mp)
{
    ...
    rv = unformat_lisp_eid_api(&a->rmt_eid, mp->vni, mp->eid_type, mp->rmt_eid, mp->rmt_len);
    rv |= unformat_lisp_eid_api(&a->lcl_eid, mp->vni, mp->eid_type, mp->lcl_eid, mp->lcl_len);
...
static void
vl_api_gpe_add_del_native_fwd_rpath_t_handler(vl_api_gpe_add_del_native_fwd_rpath_t *mp)
{
...
static void
gpe_native_fwd_rpaths_copy(vl_api_gpe_native_fwd_rpath_t *dst, fib_route_path_t *src, u8 is_ip4)
{
    fib_route_path_t *e;
    fib_table_t *table;
    u32 i = 0;
...
static void
gpe_native_fwd_rpaths_get_reply_t_host_to_net(vl_api_gpe_native_fwd_rpaths_get_reply_t *mp)
{
    u32 i;
...
static void
vl_api_gpe_native_fwd_rpaths_get_t_handler(vl_api_gpe_native_fwd_rpaths_get_t *mp)
{
    ...
    REPLY_MACRO4(VL_API_GPE_NATIVE_FWD_RPATHS_GET_REPLY, size, {
        ...
        gpe_native_fwd_rpaths_copy(rmp->entries, lgm->native_fwd_rpath[rpath_index], mp->is_ip4);
