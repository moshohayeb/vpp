...
static void
vnet_flow_classify_feature_enable(vlib_main_t *vnm, flow_classify_main_t *fcm, u32 sw_if_index,
                                  flow_classify_table_id_t tid, int feature_enable)
{
...
int
vnet_set_flow_classify_intfc(vlib_main_t *vm, u32 sw_if_index, u32 ip4_table_index, u32 ip6_table_index, u32 is_add)
{
    ...
    for (ti = 0; ti < FLOW_CLASSIFY_N_TABLES; ti++) {
        ...
        if (is_add && fcm->classify_table_index_by_sw_if_index[ti][sw_if_index] != ~0)
            return 0;
...
static clib_error_t *
set_flow_classify_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
...
static clib_error_t *
show_flow_classify_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    flow_classify_main_t *fcm = &flow_classify_main;
