...
static void
vnet_policer_classify_feature_enable(vlib_main_t *vnm, policer_classify_main_t *pcm, u32 sw_if_index,
                                     policer_classify_table_id_t tid, int feature_enable)
{
...
int
vnet_set_policer_classify_intfc(vlib_main_t *vm, u32 sw_if_index, u32 ip4_table_index, u32 ip6_table_index,
                                u32 l2_table_index, u32 is_add)
{
    ...
    for (ti = 0; ti < POLICER_CLASSIFY_N_TABLES; ti++) {
        ...
        if (is_add && pcm->classify_table_index_by_sw_if_index[ti][sw_if_index] != ~0)
            return 0;
...
static clib_error_t *
set_policer_classify_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
...
static clib_error_t *
show_policer_classify_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    policer_classify_main_t *pcm = &policer_classify_main;
