...
stats_collect_inline(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame, vlib_rx_or_tx_t rxtx)
{
...
static uword
stats_collect_rx(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame)
{
    return stats_collect_inline(vm, node, frame, VLIB_RX);
}

static uword
stats_collect_tx(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame)
{
