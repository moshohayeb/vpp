...
#define foreach_session_endpoint_fields foreach_transport_connection_fields _(u8, transport_proto)
...
#define SESSION_ENDPOINT_NULL                                                                                          \
    {                                                                                                                  \
        .sw_if_index = ENDPOINT_INVALID_INDEX, .ip = SESSION_IP46_ZERO, .fib_index = ENDPOINT_INVALID_INDEX,           \
        .is_ip4 = 0, .port = 0, .transport_proto = 0,                                                                  \
    }
#define SESSION_ENDPOINT_EXT_NULL                                                                                      \
    {                                                                                                                  \
        .sw_if_index = ENDPOINT_INVALID_INDEX, .ip = SESSION_IP46_ZERO, .fib_index = ENDPOINT_INVALID_INDEX,           \
        .is_ip4 = 0, .port = 0, .transport_proto = 0, .app_wrk_index = ENDPOINT_INVALID_INDEX,                         \
