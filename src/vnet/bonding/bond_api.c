...
static void
bond_send_sw_interface_event_deleted(vpe_api_main_t *am, unix_shared_memory_queue_t *q, u32 sw_if_index)
{
...
static void
bond_send_sw_interface_details(vpe_api_main_t *am, vl_api_registration_t *reg, bond_interface_details_t *bond_if,
                               u32 context)
{
...
static void
bond_send_sw_interface_slave_details(vpe_api_main_t *am, vl_api_registration_t *reg,
                                     slave_interface_details_t *slave_if, u32 context)
{
    ...
    clib_memcpy(mp->interface_name, slave_if->interface_name,
                MIN(ARRAY_LEN(mp->interface_name) - 1, strlen((const char *) slave_if->interface_name)));
