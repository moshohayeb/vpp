...
vnet_feature_start_device_input_x2(u32 sw_if_index, u32 *next0, u32 *next1, vlib_buffer_t *b0, vlib_buffer_t *b1)
{
    ...
    if (PREDICT_FALSE(clib_bitmap_get(fm->sw_if_index_has_features[feature_arc_index], sw_if_index))) {
        ...
        vnet_get_config_data(&cm->config_main, &b0->current_config_index, next0, /* # bytes of config data */ 0);
        vnet_get_config_data(&cm->config_main, &b1->current_config_index, next1, /* # bytes of config data */ 0);
    }
}
                                   ...
                                   vlib_buffer_t *b1, vlib_buffer_t *b2, vlib_buffer_t *b3)
{
    ...
    if (PREDICT_FALSE(clib_bitmap_get(fm->sw_if_index_has_features[feature_arc_index], sw_if_index))) {
        ...
        vnet_get_config_data(&cm->config_main, &b0->current_config_index, next0, /* # bytes of config data */ 0);
        vnet_get_config_data(&cm->config_main, &b1->current_config_index, next1, /* # bytes of config data */ 0);
        vnet_get_config_data(&cm->config_main, &b2->current_config_index, next2, /* # bytes of config data */ 0);
        vnet_get_config_data(&cm->config_main, &b3->current_config_index, next3, /* # bytes of config data */ 0);
    }
}
