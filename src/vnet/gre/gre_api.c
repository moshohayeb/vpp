...
static void
vl_api_gre_add_del_tunnel_t_handler(vl_api_gre_add_del_tunnel_t *mp)
{
...
static void
send_gre_tunnel_details(gre_tunnel_t *t, vl_api_registration_t *reg, u32 context)
{
...
vl_api_gre_tunnel_dump_t_handler(vl_api_gre_tunnel_dump_t *mp)
{
    ...
    if (~0 == sw_if_index) {
        /* *INDENT-OFF* */
        pool_foreach(t, gm->tunnels, ({ send_gre_tunnel_details(t, reg, mp->context); }));
        /* *INDENT-ON* */
    } else {
