...
#define foreach_flow_entry_ip4_n_tuple                                                                                 \
    _fe(ip4_address_and_mask_t, src_addr) _fe(ip4_address_and_mask_t, dst_addr) _fe(ip_port_and_mask_t, src_port)      \
        _fe(ip_port_and_mask_t, dst_port) _fe(ip_protocol_t, protocol)

#define foreach_flow_entry_ip6_n_tuple                                                                                 \
    _fe(ip6_address_and_mask_t, src_addr) _fe(ip6_address_and_mask_t, dst_addr) _fe(ip_port_and_mask_t, src_port)      \
        _fe(ip_port_and_mask_t, dst_port) _fe(ip_protocol_t, protocol)

#define foreach_flow_entry_ip4_vxlan                                                                                   \
    _fe(ip4_address_t, src_addr) _fe(ip4_address_t, dst_addr) _fe(u16, dst_port) _fe(u16, vni)

#define foreach_flow_entry_ip6_vxlan                                                                                   \
    _fe(ip6_address_t, src_addr) _fe(ip6_address_t, dst_addr) _fe(u16, dst_port) _fe(u16, vni)
