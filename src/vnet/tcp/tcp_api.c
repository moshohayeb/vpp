...
static void
vl_api_tcp_configure_src_addresses_t_handler(vl_api_tcp_configure_src_addresses_t *mp)
{
    ...
    if (mp->is_ipv6)
        rv = tcp_configure_v6_source_address_range(vm, (ip6_address_t *) mp->first_address,
                                                   (ip6_address_t *) mp->last_address, vrf_id);
    else
        rv = tcp_configure_v4_source_address_range(vm, (ip4_address_t *) mp->first_address,
