...
static void
bier_fmask_db_mk_key(index_t bti, const fib_route_path_t *rpath, bier_fmask_id_t *key)
{
    /*
...
u32
bier_fmask_db_find_or_create_and_lock(index_t bti, const fib_route_path_t *rpath)
{
    bier_fmask_id_t fmid;
    u32 index;
    uword *p;
