...
bier_bit_string_is_zero(const bier_bit_string_t *src)
{
    ...
    for (index = 0; index < BIER_BBS_NUM_INT_BUKCETS(src); index++) {
...
always_inline void
bier_bit_string_clear_string(const bier_bit_string_t *src, bier_bit_string_t *dest)
{
    u16 index;
...
always_inline void
bier_bit_string_logical_and_string(const bier_bit_string_t *src, bier_bit_string_t *dest)
{
    u16 index;
...
always_inline void
bier_bit_string_init(bier_bit_string_t *bbs, bier_hdr_len_id_t len, bier_bit_mask_bucket_t *buckets)
{
