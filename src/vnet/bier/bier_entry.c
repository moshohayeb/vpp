...
bier_entry_link_walk(fib_node_index_t pl_index, fib_node_index_t path_index, void *arg)
{
    bier_entry_t *be = arg;
    index_t bfmi;
...
static fib_path_list_walk_rc_t
bier_entry_unlink_walk(fib_node_index_t pl_index, fib_node_index_t path_index, void *arg)
{
    bier_entry_t *be = arg;
    index_t bfmi;
...
bier_entry_table_ecmp_walk_add_fmask(index_t btei, void *arg)
{
    ...
    if (FIB_NODE_INDEX_INVALID != be->be_path_list) {
        ...
        fib_path_list_contribute_forwarding(be->be_path_list, FIB_FORW_CHAIN_TYPE_BIER, FIB_PATH_LIST_FWD_FLAG_COLLAPSE,
                                            &dpo);
...
bier_entry_path_add(index_t bei, const fib_route_path_t *rpaths)
{
    ...
    if (FIB_NODE_INDEX_INVALID == be->be_path_list) {
        ...
        be->be_sibling_index =
            fib_path_list_child_add(be->be_path_list, FIB_NODE_TYPE_BIER_ENTRY, bier_entry_get_index(be));
    } else {

        old_pl_index = be->be_path_list;

        be->be_path_list =
            fib_path_list_copy_and_path_add(old_pl_index, (FIB_PATH_LIST_FLAG_SHARED | FIB_PATH_LIST_FLAG_NO_URPF),
                                            rpaths);
...
bier_entry_path_remove(index_t bei, const fib_route_path_t *rpaths)
{
    ...
    be->be_path_list =
        fib_path_list_copy_and_path_remove(old_pl_index, (FIB_PATH_LIST_FLAG_SHARED | FIB_PATH_LIST_FLAG_NO_URPF),
                                           rpaths);
