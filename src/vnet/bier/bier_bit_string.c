...
#define BIER_BIT_POS_IS_VALID(_bp, _str)                                                                               \
    {                                                                                                                  \
        if (!bier_bit_pos_is_valid(_bp, _str))                                                                         \
            return;                                                                                                    \
    }

void
bier_bit_string_set_bit(bier_bit_string_t *bit_string, bier_bp_t bp)
{
...
void
bier_bit_string_clear_bit(bier_bit_string_t *bit_string, bier_bp_t bp)
{
    u16 byte_pos, bit_pos;
...
u8 *
format_bier_bit_string(u8 *string, va_list *args)
{
