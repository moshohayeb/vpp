...
static inline void
bier_hdr_set_version(bier_hdr_t *hdr, bier_hdr_version_t version)
{
...
static inline void
bier_hdr_set_len_id(bier_hdr_t *hdr, bier_hdr_len_id_t len)
{
...
static inline void
bier_hdr_set_entropy(bier_hdr_t *hdr, bier_hdr_entropy_t entropy)
{
...
#define BIER_HDR_FIRST_WORD(version, len, entropy)                                                                     \
    ((BIER_HDR_1ST_NIBBLE_VALUE << BIER_HDR_1ST_NIBBLE_SHIFT) | (version << BIER_HDR_VERSION_FIELD_SHIFT) |            \
     (len << BIER_HDR_LEN_FIELD_SHIFT) | ((entropy & BIER_HDR_ENTROPY_FIELD_MASK) << BIER_HDR_ENTROPY_FIELD_SHIFT))
...
static inline void
bier_hdr_set_src_id(bier_hdr_t *bier_hdr, bier_hdr_src_id_t src_id)
{
    bier_hdr->bh_bfr_id = src_id;
}
static inline void
bier_hdr_set_proto_id(bier_hdr_t *bier_hdr, bier_hdr_proto_id_t proto)
{
...
{
    memset(&bier_hdr->bh_bit_string, 0, bier_hdr_len_id_to_num_buckets(bier_hdr_get_len_id(bier_hdr)));
}

static inline void
bier_hdr_init(bier_hdr_t *bier_hdr, bier_hdr_version_t version, bier_hdr_proto_id_t proto, bier_hdr_len_id_t len,
              bier_hdr_entropy_t entropy, bier_bp_t src)
{
...
static inline void
bier_bit_string_init_from_hdr(bier_hdr_t *bier_hdr, bier_bit_string_t *bit_string)
{
