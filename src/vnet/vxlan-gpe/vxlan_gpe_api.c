...
static void
vl_api_sw_interface_set_vxlan_gpe_bypass_t_handler(vl_api_sw_interface_set_vxlan_gpe_bypass_t *mp)
{
...
static void
vl_api_vxlan_gpe_add_del_tunnel_t_handler(vl_api_vxlan_gpe_add_del_tunnel_t *mp)
{
...
static void
send_vxlan_gpe_tunnel_details(vxlan_gpe_tunnel_t *t, vl_api_registration_t *reg, u32 context)
{
...
vl_api_vxlan_gpe_tunnel_dump_t_handler(vl_api_vxlan_gpe_tunnel_dump_t *mp)
{
    ...
    if (~0 == sw_if_index) {
        /* *INDENT-OFF* */
        pool_foreach(t, vgm->tunnels, ({ send_vxlan_gpe_tunnel_details(t, reg, mp->context); }));
        /* *INDENT-ON* */
    } else {
