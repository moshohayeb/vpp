 ...
 */
always_inline uword
vxlan_gpe_input(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *from_frame, u8 is_ip4)
{
    ...
    while (n_left_from > 0) {
        ...
        while (n_left_from >= 4 && n_left_to_next >= 2) {
            ...
            if (is_ip4) {
                next0 = (iuvn4_0->vxlan.protocol < VXLAN_GPE_PROTOCOL_MAX) ?
                            nngm->decap_next_node_list[iuvn4_0->vxlan.protocol] :
                            VXLAN_GPE_INPUT_NEXT_DROP;
                next1 = (iuvn4_1->vxlan.protocol < VXLAN_GPE_PROTOCOL_MAX) ?
            ...
            {
                next0 = (iuvn6_0->vxlan.protocol < node->n_next_nodes) ? iuvn6_0->vxlan.protocol :
                                                                         VXLAN_GPE_INPUT_NEXT_DROP;
                next1 = (iuvn6_1->vxlan.protocol < node->n_next_nodes) ? iuvn6_1->vxlan.protocol :
                                                                         VXLAN_GPE_INPUT_NEXT_DROP;
            ...
            if (is_ip4) {
                ...
                if (PREDICT_FALSE((key4_0.as_u64[0] != last_key4.as_u64[0]) || (key4_0.as_u64[1] != last_key4.as_u64[1]))) {
            ...
            {
                next0 = (iuvn6_0->vxlan.protocol < VXLAN_GPE_PROTOCOL_MAX) ?
                            nngm->decap_next_node_list[iuvn6_0->vxlan.protocol] :
                            VXLAN_GPE_INPUT_NEXT_DROP;
                next1 = (iuvn6_1->vxlan.protocol < VXLAN_GPE_PROTOCOL_MAX) ?
        ...
        trace0:
            ...
            if (is_ip4) {
                ...
                if (PREDICT_FALSE((key4_1.as_u64[0] != last_key4.as_u64[0]) || (key4_1.as_u64[1] != last_key4.as_u64[1]))) {
    ...
    vlib_node_increment_counter(vm, vxlan_gpe_input_node.index, VXLAN_GPE_ERROR_DECAPSULATED, pkts_decapsulated);
 ...
 */
static uword
vxlan4_gpe_input(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *from_frame)
{
 ...
 */
static uword
vxlan6_gpe_input(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *from_frame)
{
...
always_inline uword
ip_vxlan_gpe_bypass_inline(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame, u32 is_ip4)
{
...
static uword
ip4_vxlan_gpe_bypass(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame)
{
...
static uword
ip6_vxlan_gpe_bypass(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame)
{
