...
#define foreach_icmp6_error                                                                                            \
    ...
    _(ROUTER_SOLICITATION_SOURCE_NOT_ON_LINK, "router solicitations from source not on link")                          \
    _(ROUTER_SOLICITATION_UNSUPPORTED_INTF, "neighbor discovery unsupported  interface")                               \
    _(ROUTER_SOLICITATION_RADV_NOT_CONFIG, "neighbor discovery not configured")                                        \
    _(ROUTER_ADVERTISEMENT_SOURCE_NOT_LINK_LOCAL, "router advertisement source not link local")                        \
