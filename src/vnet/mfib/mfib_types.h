...
#define FOR_EACH_MFIB_ATTRIBUTE(_item)                                                                                 \
    for (_item = MFIB_ENTRY_ATTRIBUTE_FIRST; _item <= MFIB_ENTRY_ATTRIBUTE_LAST; _item++)

#define MFIB_ENTRY_NAMES_SHORT                                                                                         \
    {                                                                                                                  \
        [MFIB_ENTRY_SIGNAL] = "S", [MFIB_ENTRY_CONNECTED] = "C", [MFIB_ENTRY_DROP] = "D",                              \
        [MFIB_ENTRY_ACCEPT_ALL_ITF] = "AA", [MFIB_ENTRY_INHERIT_ACCEPT] = "IA", [MFIB_ENTRY_EXCLUSIVE] = "E",          \
    }

#define MFIB_ENTRY_NAMES_LONG                                                                                          \
    {                                                                                                                  \
        [MFIB_ENTRY_SIGNAL] = "Signal", [MFIB_ENTRY_CONNECTED] = "Connected", [MFIB_ENTRY_DROP] = "Drop",              \
        [MFIB_ENTRY_ACCEPT_ALL_ITF] = "Accept-all-itf", [MFIB_ENTRY_INHERIT_ACCEPT] = "Inherit-Accept",                \
...
#define FOR_EACH_MFIB_ITF_ATTRIBUTE(_item)                                                                             \
    for (_item = MFIB_ITF_ATTRIBUTE_FIRST; _item <= MFIB_ITF_ATTRIBUTE_LAST; _item++)

#define MFIB_ITF_NAMES_SHORT                                                                                           \
    {                                                                                                                  \
        [MFIB_ITF_NEGATE_SIGNAL] = "NS", [MFIB_ITF_ACCEPT] = "A", [MFIB_ITF_FORWARD] = "F",                            \
        [MFIB_ITF_SIGNAL_PRESENT] = "SP", [MFIB_ITF_DONT_PRESERVE] = "DP",                                             \
    }

#define MFIB_ITF_NAMES_LONG                                                                                            \
    {                                                                                                                  \
        [MFIB_ITF_NEGATE_SIGNAL] = "Negate-Signal", [MFIB_ITF_ACCEPT] = "Accept", [MFIB_ITF_FORWARD] = "Forward",      \
        [MFIB_ITF_SIGNAL_PRESENT] = "Signal-Present", [MFIB_ITF_DONT_PRESERVE] = "Don't-Preserve",                     \
    }
...
#define MFIB_SOURCE_NAMES                                                                                              \
    {                                                                                                                  \
        [MFIB_SOURCE_SPECIAL] = "Special", [MFIB_SOURCE_6RD] = "6RD", [MFIB_SOURCE_API] = "API",                       \
        [MFIB_SOURCE_CLI] = "CLI", [MFIB_SOURCE_DHCP] = "DHCP", [MFIB_SOURCE_VXLAN] = "VXLAN",                         \
        [MFIB_SOURCE_SRv6] = "SRv6", [MFIB_SOURCE_GTPU] = "GTPU", [MFIB_SOURCE_VXLAN_GPE] = "VXLAN-GPE",               \
        [MFIB_SOURCE_RR] = "Recursive-resolution", [MFIB_SOURCE_GENEVE] = "Geneve", [MFIB_SOURCE_IGMP] = "IGMP",       \
        [MFIB_SOURCE_VXLAN_GBP] = "VXLAN-GBP", [MFIB_SOURCE_DEFAULT_ROUTE] = "Default Route",                          \
    }
 ...
 */
extern int mfib_prefix_cmp(const mfib_prefix_t *p1, const mfib_prefix_t *p2);
...
extern uword unformat_mfib_itf_flags(unformat_input_t *input, va_list *args);
extern uword unformat_mfib_entry_flags(unformat_input_t *input, va_list *args);
