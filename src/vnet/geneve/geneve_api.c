...
static void
vl_api_sw_interface_set_geneve_bypass_t_handler(vl_api_sw_interface_set_geneve_bypass_t *mp)
{
...
static void
send_geneve_tunnel_details(geneve_tunnel_t *t, vl_api_registration_t *reg, u32 context)
{
...
vl_api_geneve_tunnel_dump_t_handler(vl_api_geneve_tunnel_dump_t *mp)
{
    ...
    if (~0 == sw_if_index) {
        /* *INDENT-OFF* */
        pool_foreach(t, vxm->tunnels, ({ send_geneve_tunnel_details(t, reg, mp->context); }));
        /* *INDENT-ON* */
    } else {
