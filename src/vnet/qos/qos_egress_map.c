...
void
qos_egress_map_update(qos_egress_map_id_t mid, qos_source_t input_source, qos_bits_t *values)
{
    qos_egress_map_t *qem;
...
static clib_error_t *
qos_egress_map_update_cli(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
...
static clib_error_t *
qos_egress_map_show(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    qos_egress_map_id_t map_id;
    qos_egress_map_t *qem;
    clib_error_t *error;
