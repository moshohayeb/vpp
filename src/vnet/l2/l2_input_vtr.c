...
static uword
l2_invtr_node_fn(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame)
{
...
l2_invtr_init(vlib_main_t *vm)
{
    ...
    feat_bitmap_init_next_nodes(vm, l2_invtr_node.index, L2INPUT_N_FEAT, l2input_get_feat_names(),
