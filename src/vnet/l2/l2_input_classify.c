...
static uword
l2_input_classify_node_fn(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame)
{
...
l2_input_classify_init(vlib_main_t *vm)
{
    ...
    feat_bitmap_init_next_nodes(vm, l2_input_classify_node.index, L2INPUT_N_FEAT, l2input_get_feat_names(),
                                cm->l2_inp_feat_next);
    rt->l2cm = cm;
...
int
vnet_l2_input_classify_set_tables(u32 sw_if_index, u32 ip4_table_index, u32 ip6_table_index, u32 other_table_index)
{
    l2_input_classify_main_t *cm = &l2_input_classify_main;
    vnet_classify_main_t *vcm    = cm->vnet_classify_main;
...
static clib_error_t *
int_l2_input_classify_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
...
VLIB_CLI_COMMAND(int_l2_input_classify_cli, static) = {
    ...
    .short_help = "set interface l2 input classify intfc <interface-name> [ip4-table <n>]\n"
