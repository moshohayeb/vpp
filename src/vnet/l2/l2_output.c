...
split_horizon_violation(vlib_node_runtime_t *node, u8 shg, vlib_buffer_t *b, u16 *next)
{
...
static_always_inline void
l2output_process_batch_inline(vlib_main_t *vm, vlib_node_runtime_t *node, l2_output_config_t *config, vlib_buffer_t **b,
                              i16 *cdo, u16 *next, u32 n_left, int l2_efp, int l2_vtr, int l2_pbb, int shg_set,
...
static_always_inline void
l2output_process_batch(vlib_main_t *vm, vlib_node_runtime_t *node, l2_output_config_t *config, vlib_buffer_t **b,
                       i16 *cdo, u16 *next, u32 n_left, int l2_efp, int l2_vtr, int l2_pbb)
{
...
l2output_init(vlib_main_t *vm)
{
    ...
    feat_bitmap_init_next_nodes(vm, l2output_node.index, L2OUTPUT_N_FEAT, l2output_get_feat_names(),
                                mp->l2_out_feat_next);
