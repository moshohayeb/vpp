...
static void
fib_entry_src_default_path_add(fib_entry_src_t *src, fib_protocol_t proto, const ip46_address_t *next_hop,
                               u32 next_hop_sw_if_index, u32 next_hop_fib_index, u32 next_hop_weight)
{
}

static void
fib_entry_src_default_path_remove(fib_entry_src_t *src, fib_protocol_t proto, const ip46_address_t *next_hop,
                                  u32 next_hop_sw_if_index, u32 next_hop_fib_index, u32 next_hop_weight)
{
}
 ...
 */
static void
fib_entry_src_default_activate(fib_entry_src_t *src, const fib_entry_t *fib_entry)
{
}
 ...
 */
static void
fib_entry_src_default_deactivate(fib_entry_src_t *src, const fib_entry_t *fib_entry)
{
}

static void
fib_entry_src_default_add(fib_entry_src_t *src, fib_entry_flag_t flags, fib_protocol_t proto)
{
}
