...
extern u32 fib_node_list_push_front(fib_node_list_t head, int owner_id, fib_node_type_t type, fib_node_index_t index);
extern u32 fib_node_list_push_back(fib_node_list_t head, int owner_id, fib_node_type_t type, fib_node_index_t index);
extern void fib_node_list_remove(fib_node_list_t head, u32 sibling);
extern void fib_node_list_elt_remove(u32 sibling);

extern int fib_node_list_advance(u32 sibling);

extern int fib_node_list_get_front(fib_node_list_t head, fib_node_ptr_t *ptr);

extern int fib_node_list_elt_get_next(u32 elt, fib_node_ptr_t *ptr);
...
extern void fib_node_list_walk(fib_node_list_t head, fib_node_list_walk_cb_t fn, void *args);
