...
int
mpls_sw_interface_enable_disable(mpls_main_t *mm, u32 sw_if_index, u8 is_enable, u8 is_api)
{
    ...
    if (is_enable) {
        ...
        fib_table_lock(lfib_index, FIB_PROTOCOL_MPLS, (is_api ? FIB_SOURCE_API : FIB_SOURCE_CLI));
...
static clib_error_t *
mpls_interface_enable_disable(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
