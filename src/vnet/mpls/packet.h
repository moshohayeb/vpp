...
{
    *label_exp_s_ttl =
        (((*label_exp_s_ttl) & ~(MPLS_ENTRY_LABEL_BITS)) | ((value & MPLS_ENTRY_LABEL_MASK) << MPLS_ENTRY_LABEL_SHIFT));
}
...
{
    *label_exp_s_ttl =
        (((*label_exp_s_ttl) & ~(MPLS_ENTRY_EXP_BITS)) | ((exp & MPLS_ENTRY_EXP_MASK) << MPLS_ENTRY_EXP_SHIFT));
}
...
{
    *label_exp_s_ttl =
        (((*label_exp_s_ttl) & ~(MPLS_ENTRY_EOS_BIT)) | ((eos & MPLS_ENTRY_EOS_MASK) << MPLS_ENTRY_EOS_SHIFT));
}
