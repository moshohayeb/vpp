...
static void
lldp_rpc_update_peer(u32 hw_if_index, const u8 *chid, u8 chid_len, u8 chid_subtype, const u8 *portid, u8 portid_len,
...
#undef F
    ...
    /* last tlv is pdu_end */
    if (TLV_VIOLATES_PKT_BOUNDARY(pkt, tlv) || LLDP_TLV_NAME(pdu_end) != lldp_tlv_get_code(tlv) ||
