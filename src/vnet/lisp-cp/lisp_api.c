...
static int
unformat_lisp_eid_api(gid_address_t *dst, u32 vni, u8 type, void *src, u8 len)
{
    switch (type) {
    case 0: /* ipv4 */
...
vl_api_lisp_add_del_local_eid_t_handler(vl_api_lisp_add_del_local_eid_t *mp)
{
    ...
    rv = unformat_lisp_eid_api(eid, clib_net_to_host_u32(mp->vni), mp->eid_type, mp->eid, mp->prefix_len);
    if (rv)
        goto out;
...
static void
vl_api_lisp_eid_table_add_del_map_t_handler(vl_api_lisp_eid_table_add_del_map_t *mp)
{
...
static void
vl_api_lisp_add_del_map_server_t_handler(vl_api_lisp_add_del_map_server_t *mp)
{
...
static void
vl_api_lisp_add_del_map_resolver_t_handler(vl_api_lisp_add_del_map_resolver_t *mp)
{
...
static void
vl_api_lisp_map_register_enable_disable_t_handler(vl_api_lisp_map_register_enable_disable_t *mp)
{
...
static void
vl_api_lisp_rloc_probe_enable_disable_t_handler(vl_api_lisp_rloc_probe_enable_disable_t *mp)
{
...
static void
vl_api_show_lisp_map_request_mode_t_handler(vl_api_show_lisp_map_request_mode_t *mp)
{
    int rv = 0;
    vl_api_show_lisp_map_request_mode_reply_t *rmp;

    /* *INDENT-OFF* */
    REPLY_MACRO2(VL_API_SHOW_LISP_MAP_REQUEST_MODE_REPLY, ({ rmp->mode = vnet_lisp_get_map_request_mode(); }));
    /* *INDENT-ON* */
}
...
static void
vl_api_lisp_pitr_set_locator_set_t_handler(vl_api_lisp_pitr_set_locator_set_t *mp)
{
...
static void
vl_api_lisp_add_del_map_request_itr_rlocs_t_handler(vl_api_lisp_add_del_map_request_itr_rlocs_t *mp)
{
...
static void
vl_api_lisp_add_del_remote_mapping_t_handler(vl_api_lisp_add_del_remote_mapping_t *mp)
{
    locator_t *rlocs = 0;
    ...
    rv = unformat_lisp_eid_api(eid, clib_net_to_host_u32(mp->vni), mp->eid_type, mp->eid, mp->eid_len);
    if (rv)
        goto send_reply;
...
vl_api_lisp_add_del_adjacency_t_handler(vl_api_lisp_add_del_adjacency_t *mp)
{
    ...
    rv = unformat_lisp_eid_api(&a->leid, clib_net_to_host_u32(mp->vni), mp->eid_type, mp->leid, mp->leid_len);
    rv |= unformat_lisp_eid_api(&a->reid, clib_net_to_host_u32(mp->vni), mp->eid_type, mp->reid, mp->reid_len);
...
static void
send_lisp_locator_details(lisp_cp_main_t *lcm, locator_t *loc, vl_api_registration_t *reg, u32 context)
{
...
static void
send_lisp_locator_set_details(lisp_cp_main_t *lcm, locator_set_t *lsit, vl_api_registration_t *reg, u32 context,
                              u32 ls_index)
{
...
static void
send_lisp_eid_table_details(mapping_t *mapit, vl_api_registration_t *reg, u32 context, u8 filter)
{
    fid_address_t *fid;
    lisp_cp_main_t *lcm                  = vnet_lisp_cp_get_main();
    locator_set_t *ls                    = 0;
    ...
    case GID_ADDR_SRC_DST:
        ...
        lisp_fid_put_api(rmp->seid, &gid_address_sd_src(gid), &rmp->seid_prefix_len);
        lisp_fid_put_api(rmp->eid, &gid_address_sd_dst(gid), &rmp->eid_prefix_len);
        break;
...
vl_api_lisp_eid_table_dump_t_handler(vl_api_lisp_eid_table_dump_t *mp)
{
    ...
    if (mp->eid_set) {
        ...
        /* *INDENT-OFF* */
        pool_foreach(mapit, lcm->mapping_pool, ({ send_lisp_eid_table_details(mapit, reg, mp->context, mp->filter); }));
        /* *INDENT-ON* */
    }
}

static void
send_lisp_map_server_details(ip_address_t *ip, vl_api_registration_t *reg, u32 context)
{
...
static void
send_lisp_map_resolver_details(ip_address_t *ip, vl_api_registration_t *reg, u32 context)
{
...
static void
vl_api_lisp_eid_table_map_dump_t_handler(vl_api_lisp_eid_table_map_dump_t *mp)
{
    vl_api_registration_t *reg;
    lisp_cp_main_t *lcm = vnet_lisp_cp_get_main();
    hash_pair_t *p;
...
static void
vl_api_show_lisp_rloc_probe_state_t_handler(vl_api_show_lisp_rloc_probe_state_t *mp)
{
...
static void
vl_api_show_lisp_map_register_state_t_handler(vl_api_show_lisp_map_register_state_t *mp)
{
...
static void
vl_api_lisp_eid_table_vni_dump_t_handler(vl_api_lisp_eid_table_vni_dump_t *mp)
{
    hash_pair_t *p;
    u32 *vnis                  = 0;
    vl_api_registration_t *reg = 0;
...
static void
vl_api_lisp_get_map_request_itr_rlocs_t_handler(vl_api_lisp_get_map_request_itr_rlocs_t *mp)
{
