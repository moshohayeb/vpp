...
static void
vl_api_one_map_register_set_ttl_t_handler(vl_api_one_map_register_set_ttl_t *mp)
{
...
static void
vl_api_show_one_map_register_ttl_t_handler(vl_api_show_one_map_register_ttl_t *mp)
{
...
static void
vl_api_one_add_del_locator_set_t_handler(vl_api_one_add_del_locator_set_t *mp)
{
...
static int
unformat_one_eid_api(gid_address_t *dst, u32 vni, u8 type, void *src, u8 len)
{
    lisp_nsh_api_t *nsh;
...
vl_api_one_add_del_local_eid_t_handler(vl_api_one_add_del_local_eid_t *mp)
{
    ...
    rv = unformat_one_eid_api(eid, clib_net_to_host_u32(mp->vni), mp->eid_type, mp->eid, mp->prefix_len);
    if (rv)
        goto out;
...
static void
vl_api_one_eid_table_add_del_map_t_handler(vl_api_one_eid_table_add_del_map_t *mp)
{
    vl_api_one_eid_table_add_del_map_reply_t *rmp;
    int rv = 0;
    rv     = vnet_lisp_eid_table_map(clib_net_to_host_u32(mp->vni), clib_net_to_host_u32(mp->dp_table), mp->is_l2,
                                 mp->is_add);
...
static void
vl_api_one_add_del_map_resolver_t_handler(vl_api_one_add_del_map_resolver_t *mp)
{
...
static void
vl_api_one_map_register_enable_disable_t_handler(vl_api_one_map_register_enable_disable_t *mp)
{
...
static void
vl_api_one_rloc_probe_enable_disable_t_handler(vl_api_one_rloc_probe_enable_disable_t *mp)
{
...
static void
vl_api_show_one_map_request_mode_t_handler(vl_api_show_one_map_request_mode_t *mp)
{
    int rv = 0;
...
static void
vl_api_one_nsh_set_locator_set_t_handler(vl_api_one_nsh_set_locator_set_t *mp)
{
...
static void
vl_api_one_pitr_set_locator_set_t_handler(vl_api_one_pitr_set_locator_set_t *mp)
{
...
vl_api_show_one_use_petr_t_handler(vl_api_show_one_use_petr_t *mp)
{
    ...
    REPLY_MACRO2(VL_API_SHOW_ONE_USE_PETR_REPLY, {
        ...
        case IP4:
            clib_memcpy(rmp->address, &ip_addr_v4(ip), sizeof(ip_addr_v4(ip)));
            break;

        case IP6:
            clib_memcpy(rmp->address, &ip_addr_v6(ip), sizeof(ip_addr_v6(ip)));
            break;
...
static void
vl_api_one_add_del_map_request_itr_rlocs_t_handler(vl_api_one_add_del_map_request_itr_rlocs_t *mp)
{
...
static void
vl_api_one_add_del_remote_mapping_t_handler(vl_api_one_add_del_remote_mapping_t *mp)
{
    locator_t *rlocs = 0;
    ...
    rv = unformat_one_eid_api(eid, clib_net_to_host_u32(mp->vni), mp->eid_type, mp->eid, mp->eid_len);
    if (rv)
        goto send_reply;
...
vl_api_one_add_del_adjacency_t_handler(vl_api_one_add_del_adjacency_t *mp)
{
    ...
    rv = unformat_one_eid_api(&a->leid, clib_net_to_host_u32(mp->vni), mp->eid_type, mp->leid, mp->leid_len);
    rv |= unformat_one_eid_api(&a->reid, clib_net_to_host_u32(mp->vni), mp->eid_type, mp->reid, mp->reid_len);
...
static void
send_one_locator_details(lisp_cp_main_t *lcm, locator_t *loc, vl_api_registration_t *reg, u32 context)
{
...
static void
send_one_locator_set_details(lisp_cp_main_t *lcm, locator_set_t *lsit, vl_api_registration_t *reg, u32 context,
                             u32 ls_index)
{
...
static void
send_one_eid_table_details(mapping_t *mapit, vl_api_registration_t *reg, u32 context, u8 filter)
{
    fid_address_t *fid;
    lisp_cp_main_t *lcm                 = vnet_lisp_cp_get_main();
    locator_set_t *ls                   = 0;
    ...
    case GID_ADDR_SRC_DST:
        ...
        one_fid_put_api(rmp->seid, &gid_address_sd_src(gid), &rmp->seid_prefix_len);
        one_fid_put_api(rmp->eid, &gid_address_sd_dst(gid), &rmp->eid_prefix_len);
        break;
    case GID_ADDR_IP_PREFIX:
        rmp->eid_prefix_len = ip_prefix_len(ip_prefix);
        if (ip_prefix_version(ip_prefix) == IP4) {
            rmp->eid_type = 0; /* ipv4 type */
            clib_memcpy(rmp->eid, &ip_prefix_v4(ip_prefix), sizeof(ip_prefix_v4(ip_prefix)));
        } else {
            rmp->eid_type = 1; /* ipv6 type */
            clib_memcpy(rmp->eid, &ip_prefix_v6(ip_prefix), sizeof(ip_prefix_v6(ip_prefix)));
        }
        break;
    case GID_ADDR_MAC:
...
vl_api_one_eid_table_dump_t_handler(vl_api_one_eid_table_dump_t *mp)
{
    ...
    if (mp->eid_set) {
        ...
        unformat_one_eid_api(eid, clib_net_to_host_u32(mp->vni), mp->eid_type, mp->eid, mp->prefix_length);
        ...
        /* *INDENT-OFF* */
        pool_foreach(mapit, lcm->mapping_pool, ({ send_one_eid_table_details(mapit, reg, mp->context, mp->filter); }));
        /* *INDENT-ON* */
    }
}

static void
send_one_map_server_details(ip_address_t *ip, vl_api_registration_t *reg, u32 context)
{
...
static void
send_one_map_resolver_details(ip_address_t *ip, vl_api_registration_t *reg, u32 context)
{
...
static void
send_eid_table_map_pair(hash_pair_t *p, vl_api_registration_t *reg, u32 context)
{
...
static void
vl_api_show_one_rloc_probe_state_t_handler(vl_api_show_one_rloc_probe_state_t *mp)
{
    vl_api_show_one_rloc_probe_state_reply_t *rmp = 0;
    int rv                                        = 0;

    /* *INDENT-OFF* */
    REPLY_MACRO2(VL_API_SHOW_ONE_RLOC_PROBE_STATE_REPLY, { rmp->is_enabled = vnet_lisp_rloc_probe_state_get(); });
    /* *INDENT-ON* */
}

static void
vl_api_show_one_map_register_state_t_handler(vl_api_show_one_map_register_state_t *mp)
{
    vl_api_show_one_map_register_state_reply_t *rmp = 0;
    int rv                                          = 0;

    /* *INDENT-OFF* */
    REPLY_MACRO2(VL_API_SHOW_ONE_MAP_REGISTER_STATE_REPLY, { rmp->is_enabled = vnet_lisp_map_register_state_get(); });
    /* *INDENT-ON* */
}
...
static void
vl_api_one_get_map_request_itr_rlocs_t_handler(vl_api_one_get_map_request_itr_rlocs_t *mp)
{
...
static void
vl_api_show_one_stats_enable_disable_t_handler(vl_api_show_one_stats_enable_disable_t *mp)
{
    vl_api_show_one_stats_enable_disable_reply_t *rmp = NULL;
    vnet_api_error_t rv                               = 0;

    /* *INDENT-OFF* */
    REPLY_MACRO2(VL_API_SHOW_ONE_STATS_ENABLE_DISABLE_REPLY, ({ rmp->is_en = vnet_lisp_stats_enable_disable_state(); }));
    /* *INDENT-ON* */
}

static void
vl_api_one_stats_enable_disable_t_handler(vl_api_one_stats_enable_disable_t *mp)
{
...
static void
lisp_fid_addr_to_api(fid_address_t *fid, u8 *dst, u8 *api_eid_type, u8 *prefix_length)
{
    switch (fid_addr_type(fid)) {
    case FID_ADDR_IP_PREF:
...
vl_api_one_stats_dump_t_handler(vl_api_one_stats_dump_t *mp)
{
    ...
    vec_foreach(stat, stats)
    {
        ...
        REPLY_DETAILS(VL_API_ONE_STATS_DETAILS, ({
                          lisp_fid_addr_to_api(&stat->deid, rmp->deid, &rmp->eid_type, &rmp->deid_pref_len);
                          lisp_fid_addr_to_api(&stat->seid, rmp->seid, &rmp->eid_type, &rmp->seid_pref_len);
...
static void
vl_api_one_add_del_l2_arp_entry_t_handler(vl_api_one_add_del_l2_arp_entry_t *mp)
{
...
static void
vl_api_one_map_register_fallback_threshold_t_handler(vl_api_one_map_register_fallback_threshold_t *mp)
{
...
static void
vl_api_show_one_map_register_fallback_threshold_t_handler(vl_api_show_one_map_register_fallback_threshold_t *mp)
{
...
static void
vl_api_one_set_transport_protocol_t_handler(vl_api_one_set_transport_protocol_t *mp)
{
...
static void
vl_api_one_get_transport_protocol_t_handler(vl_api_one_get_transport_protocol_t *mp)
{
...
static void
vl_api_one_enable_disable_xtr_mode_t_handler(vl_api_one_enable_disable_xtr_mode_t *mp)
{
...
vl_api_one_show_xtr_mode_t_handler(vl_api_one_show_xtr_mode_t *mp)
{
    ...
    /* *INDENT-OFF* */
    REPLY_MACRO2(VL_API_ONE_SHOW_XTR_MODE_REPLY, { rmp->is_en = vnet_lisp_get_xtr_mode(); });
    /* *INDENT-ON* */
}

static void
vl_api_one_enable_disable_pitr_mode_t_handler(vl_api_one_enable_disable_pitr_mode_t *mp)
{
...
vl_api_one_show_pitr_mode_t_handler(vl_api_one_show_pitr_mode_t *mp)
{
    ...
    /* *INDENT-OFF* */
    REPLY_MACRO2(VL_API_ONE_SHOW_PITR_MODE_REPLY, { rmp->is_en = vnet_lisp_get_pitr_mode(); });
    /* *INDENT-ON* */
}

static void
vl_api_one_enable_disable_petr_mode_t_handler(vl_api_one_enable_disable_petr_mode_t *mp)
{
...
vl_api_one_show_petr_mode_t_handler(vl_api_one_show_petr_mode_t *mp)
{
    ...
    /* *INDENT-OFF* */
    REPLY_MACRO2(VL_API_ONE_SHOW_PETR_MODE_REPLY, { rmp->is_en = vnet_lisp_get_petr_mode(); });
    /* *INDENT-ON* */
}
