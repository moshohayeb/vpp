...
static clib_error_t *
lisp_show_adjacencies_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
...
static clib_error_t *
lisp_add_del_map_server_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    int rv    = 0;
    ...
    if (!rv)
        vlib_cli_output(vm, "failed to %s map-server!", is_add ? "add" : "delete");
...
static clib_error_t *
lisp_add_del_local_eid_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
...
static clib_error_t *
lisp_eid_table_map_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    u8 is_add = 1, is_l2 = 0;
    u32 vni = 0, dp_id                        = 0;
    unformat_input_t _line_input, *line_input = &_line_input;
...
static clib_error_t *
lisp_add_del_ndp_entry_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    unformat_input_t _line_input, *line_input = &_line_input;
    clib_error_t *error = NULL;
    int rc              = 0;
...
static clib_error_t *
lisp_add_del_l2_arp_entry_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    unformat_input_t _line_input, *line_input = &_line_input;
    clib_error_t *error = NULL;
    int rc              = 0;
...
static clib_error_t *
lisp_show_l2_arp_entries_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
...
static clib_error_t *
lisp_show_ndp_entries_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
 ...
 */
static clib_error_t *
lisp_add_del_remote_mapping_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    clib_error_t *error = 0;
    unformat_input_t _line_input, *line_input = &_line_input;
...
VLIB_CLI_COMMAND(one_add_del_remote_mapping_command) = {
    ...
    .short_help = "one remote-mapping add|del [del-all] vni <vni> "
 ...
 */
static clib_error_t *
lisp_add_del_adjacency_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    clib_error_t *error = 0;
    unformat_input_t _line_input, *line_input = &_line_input;
    vnet_lisp_add_del_adjacency_args_t _a, *a = &_a;
...
static clib_error_t *
lisp_map_request_mode_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
...
static clib_error_t *
lisp_show_map_request_mode_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
...
static clib_error_t *
lisp_show_map_resolvers_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    lisp_msmr_t *mr;
    lisp_cp_main_t *lcm = vnet_lisp_cp_get_main();
...
static clib_error_t *
lisp_nsh_set_locator_set_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
...
static clib_error_t *
lisp_map_register_fallback_threshold_show_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
...
static clib_error_t *
lisp_map_register_fallback_threshold_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    unformat_input_t _line_input, *line_input = &_line_input;
    clib_error_t *error = 0;
    u32 val             = 0;
...
static clib_error_t *
lisp_pitr_set_locator_set_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    u8 locator_name_set  = 0;
    u8 *locator_set_name = 0;
    u8 is_add            = 1;
...
static clib_error_t *
lisp_show_pitr_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    lisp_cp_main_t *lcm = vnet_lisp_cp_get_main();
    mapping_t *m;
    locator_set_t *ls;
...
format_eid_entry(u8 *s, va_list *args)
{
    ...
    if (vec_len(ls->locator_indices) == 0) {
        s = format(s, "%-35U%-20saction:%-30U%-20u%-u", format_gid_address, gid, type, format_negative_mapping_action,
                   mapit->action, ttl, aut);
    } else {
...
static clib_error_t *
lisp_show_eid_table_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    lisp_cp_main_t *lcm = vnet_lisp_cp_get_main();
    mapping_t *mapit;
    unformat_input_t _line_input, *line_input = &_line_input;
...
static clib_error_t *
lisp_enable_disable_pitr_mode_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    unformat_input_t _line_input, *line_input = &_line_input;
    u8 is_enabled       = 0;
    u8 is_set           = 0;
...
static clib_error_t *
lisp_enable_disable_petr_mode_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    unformat_input_t _line_input, *line_input = &_line_input;
    u8 is_enabled       = 0;
    u8 is_set           = 0;
...
static clib_error_t *
lisp_enable_disable_xtr_mode_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    unformat_input_t _line_input, *line_input = &_line_input;
    u8 is_enabled       = 0;
    u8 is_set           = 0;
...
static clib_error_t *
lisp_enable_disable_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    unformat_input_t _line_input, *line_input = &_line_input;
    u8 is_enabled       = 0;
    u8 is_set           = 0;
...
static clib_error_t *
lisp_map_register_set_ttl_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    unformat_input_t _line_input, *line_input = &_line_input;
    u32 ttl             = 0;
    u8 is_set           = 0;
...
static clib_error_t *
lisp_map_register_show_ttl_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
...
static clib_error_t *
lisp_map_register_enable_disable_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    unformat_input_t _line_input, *line_input = &_line_input;
    u8 is_enabled       = 0;
    u8 is_set           = 0;
...
static clib_error_t *
lisp_rloc_probe_enable_disable_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    unformat_input_t _line_input, *line_input = &_line_input;
    u8 is_enabled       = 0;
    u8 is_set           = 0;
...
static clib_error_t *
lisp_show_status_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    u8 *msg = 0;
...
static clib_error_t *
lisp_show_eid_table_map_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    hash_pair_t *p;
    unformat_input_t _line_input, *line_input = &_line_input;
    lisp_cp_main_t *lcm = vnet_lisp_cp_get_main();
...
static clib_error_t *
lisp_add_del_locator_set_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    ...
    while (unformat_check_input(line_input) != UNFORMAT_END_OF_INPUT) {
        if (unformat(line_input, "add %_%v%_", &locator_set_name))
            ...
            is_add = 0;
        else if (unformat(line_input, "iface %U p %d w %d", unformat_vnet_sw_interface, vnm, &locator.sw_if_index,
...
static clib_error_t *
lisp_add_del_locator_in_set_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    lisp_gpe_main_t *lgm = &lisp_gpe_main;
    vnet_main_t *vnm     = lgm->vnet_main;
    unformat_input_t _line_input, *line_input = &_line_input;
...
static clib_error_t *
lisp_cp_show_locator_sets_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    locator_set_t *lsit;
    locator_t *loc;
    u32 *locit;
    ...
    pool_foreach(lsit, lcm->locator_set_pool, ({
                     ...
                     vec_foreach(locit, lsit->locator_indices)
                     {
                         ...
                         if (loc->local)
                             ...
                             msg = format(msg, "%16U%16d%16d\n", format_ip_address, &gid_address_ip(&loc->address),
...
static clib_error_t *
lisp_add_del_map_resolver_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    unformat_input_t _line_input, *line_input = &_line_input;
...
static clib_error_t *
lisp_add_del_mreq_itr_rlocs_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    unformat_input_t _line_input, *line_input = &_line_input;
    u8 is_add            = 1;
    u8 *locator_set_name = 0;
...
static clib_error_t *
lisp_show_mreq_itr_rlocs_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    lisp_cp_main_t *lcm = vnet_lisp_cp_get_main();
...
static clib_error_t *
lisp_use_petr_set_locator_set_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    u8 is_add = 1, ip_set                     = 0;
    unformat_input_t _line_input, *line_input = &_line_input;
    clib_error_t *error = 0;
...
static clib_error_t *
lisp_show_petr_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    lisp_cp_main_t *lcm = vnet_lisp_cp_get_main();
    mapping_t *m;
    locator_set_t *ls;
...
static clib_error_t *
lisp_show_map_servers_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    lisp_msmr_t *ms;
    lisp_cp_main_t *lcm = vnet_lisp_cp_get_main();
...
static clib_error_t *
lisp_show_map_register_state_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    u8 *msg       = 0;
...
static clib_error_t *
lisp_show_rloc_probe_state_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    u8 *msg       = 0;
...
static clib_error_t *
lisp_show_stats_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
...
static clib_error_t *
lisp_show_stats_details_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    ...
    {
        vlib_cli_output(vm, "[%U, %U] [%U, %U] %7u %7u\n", format_fid_address, &stat->seid, format_fid_address,
                        &stat->deid, format_ip_address, &stat->loc_rloc, format_ip_address, &stat->rmt_rloc,
...
static clib_error_t *
lisp_stats_enable_disable_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    unformat_input_t _line_input, *line_input = &_line_input;
    u8 enable = 0;
...
static clib_error_t *
lisp_stats_flush_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
...
static clib_error_t *
lisp_show_one_modes_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
