...
static void
vl_api_sw_interface_span_enable_disable_t_handler(vl_api_sw_interface_span_enable_disable_t *mp)
{
    ...
    rv = span_add_delete_entry(vm, ntohl(mp->sw_if_index_from), ntohl(mp->sw_if_index_to), mp->state,
