...
#define DPO_PROTOS                                                                                                     \
    {                                                                                                                  \
        [DPO_PROTO_IP4] = "ip4", [DPO_PROTO_IP6] = "ip6", [DPO_PROTO_ETHERNET] = "ethernet",                           \
        [DPO_PROTO_MPLS] = "mpls", [DPO_PROTO_NSH] = "nsh", [DPO_PROTO_BIER] = "bier",                                 \
    }

#define FOR_EACH_DPO_PROTO(_proto) for (_proto = DPO_PROTO_IP4; _proto <= DPO_PROTO_NSH; _proto++)
...
#define DPO_TYPES                                                                                                      \
    {                                                                                                                  \
        [DPO_FIRST] = "dpo-invalid", [DPO_DROP] = "dpo-drop", [DPO_IP_NULL] = "dpo-ip-null", [DPO_PUNT] = "dpo-punt",  \
        [DPO_ADJACENCY] = "dpo-adjacency", [DPO_ADJACENCY_INCOMPLETE] = "dpo-adjacency-incomplete",                    \
        [DPO_ADJACENCY_MIDCHAIN] = "dpo-adjacency-midcahin", [DPO_ADJACENCY_GLEAN] = "dpo-glean",                      \
        [DPO_ADJACENCY_MCAST] = "dpo-adj-mcast", [DPO_ADJACENCY_MCAST_MIDCHAIN] = "dpo-adj-mcast-midchain",            \
        [DPO_RECEIVE] = "dpo-receive", [DPO_LOOKUP] = "dpo-lookup", [DPO_LOAD_BALANCE] = "dpo-load-balance",           \
        [DPO_REPLICATE] = "dpo-replicate", [DPO_LISP_CP] = "dpo-lisp-cp", [DPO_CLASSIFY] = "dpo-classify",             \
        [DPO_MPLS_DISPOSITION_PIPE]    = "dpo-mpls-diposition-pipe",                                                   \
        [DPO_MPLS_DISPOSITION_UNIFORM] = "dpo-mpls-diposition-uniform", [DPO_MFIB_ENTRY] = "dpo-mfib-entry",           \
        [DPO_INTERFACE_RX] = "dpo-interface-rx", [DPO_INTERFACE_TX] = "dpo-interface-tx", [DPO_DVR] = "dpo-dvr",       \
        [DPO_L3_PROXY] = "dpo-l3-proxy", [DPO_BIER_TABLE] = "bier-table", [DPO_BIER_FMASK] = "bier-fmask",             \
        [DPO_BIER_IMP] = "bier-imposition", [DPO_BIER_DISP_ENTRY] = "bier-disp-entry",                                 \
        [DPO_BIER_DISP_TABLE] = "bier-disp-table", [DPO_IP6_LL] = "ip6-link-local",                                    \
    }
...
STATIC_ASSERT(sizeof(dpo_id_t) <= sizeof(u64), "DPO ID is greater than sizeof u64 "
...
#define DPO_INVALID                                                                                                    \
    {                                                                                                                  \
        .dpoi_type = DPO_FIRST, .dpoi_proto = DPO_PROTO_NONE, .dpoi_index = INDEX_INVALID, .dpoi_next_node = 0,        \
    }
...
{
    return (dpoi->dpoi_type != DPO_FIRST && dpoi->dpoi_index != INDEX_INVALID);
}
