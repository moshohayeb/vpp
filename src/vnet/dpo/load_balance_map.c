...
#define LOAD_BALANCE_MAP_DBG(_pl, _fmt, _args...)                                                                      \
    {                                                                                                                  \
        clib_warning("lbm: FIXME" _fmt, ##_args);                                                                      \
    }
#else
#define LOAD_BALANCE_MAP_DBG(_pl, _fmt, _args...)
#endif
...
load_balance_map_db_insert(load_balance_map_t *lbm)
{
     ...
     */
    hash_set(load_balance_map_db, load_balance_map_db_hash_key_from_index(load_balance_map_get_index(lbm)),
...
static load_balance_map_t *
load_balance_map_init(load_balance_map_t *lbm, u32 n_buckets, u32 sum_of_weights)
{
...
index_t
load_balance_map_add_or_lock(u32 n_buckets, u32 sum_of_weights, const load_balance_path_t *paths)
{
...
load_balance_map_module_init(void)
{
    load_balance_map_db = hash_create2(/* elts */ 0,
                                       /* user */ 0,
                                       /* value_bytes */ sizeof(index_t), load_balance_map_db_hash_key_sum,
...
{
    fib_show_memory_usage("Load-Balance Map", pool_elts(load_balance_map_pool), pool_len(load_balance_map_pool),
                          sizeof(load_balance_map_t));
}

static clib_error_t *
load_balance_map_show(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
