 ...
 */
void
interface_tx_dpo_add_or_lock(dpo_proto_t proto, u32 sw_if_index, dpo_id_t *dpo)
{
...
format_interface_tx_dpo(u8 *s, va_list *ap)
{
    ...
    return (format(s, "%U-tx-dpo:", format_vnet_sw_interface_name, vnm, vnet_get_sw_interface(vnm, index)));
}
