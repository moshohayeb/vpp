...
static u32
dhcp_proxy_server_find(dhcp_proxy_t *proxy, fib_protocol_t proto, ip46_address_t *addr, u32 server_table_id)
{
...
int
dhcp_proxy_server_del(fib_protocol_t proto, u32 rx_fib_index, ip46_address_t *addr, u32 server_table_id)
{
    dhcp_proxy_main_t *dpm = &dhcp_proxy_main;
...
int
dhcp_proxy_server_add(fib_protocol_t proto, ip46_address_t *addr, ip46_address_t *src_address, u32 rx_fib_index,
                      u32 server_table_id)
{
    dhcp_proxy_main_t *dpm = &dhcp_proxy_main;
    dhcp_proxy_t *proxy    = 0;
...
void
update_vss(dhcp_vss_t *v, u8 vss_type, u8 *vpn_ascii_id, u32 oui, u32 vpn_index)
{
    v->vss_type = vss_type;
    if (v->vpn_ascii_id) {
...
int
dhcp_proxy_set_vss(fib_protocol_t proto, u32 tbl_id, u8 vss_type, u8 *vpn_ascii_id, u32 oui, u32 vpn_index, u8 is_del)
{
