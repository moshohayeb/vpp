...
static inline void BV(clib_bihash_lock_bucket)(BVT(clib_bihash_bucket) * b)
{
    ...
    do {
        ...
        CLIB_PAUSE();
    } while (__atomic_compare_exchange_n(&b->as_u64, &unlocked_bucket.as_u64, locked_bucket.as_u64, 1 /* weak */,
...
static inline int BV(clib_bihash_search_inline_2_with_hash)(BVT(clib_bihash) * h, u64 hash,
...
static inline int BV(clib_bihash_search_inline_2)(BVT(clib_bihash) * h, BVT(clib_bihash_kv) * search_key,
                                                  BVT(clib_bihash_kv) * valuep)
{
    u64 hash;
