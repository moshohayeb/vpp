...
#define WARN_OFF(x)                                                                                                    \
    WARN_PRAGMA(push) WARN_PRAGMA(ignored "-Wpragmas") WARN_PRAGMA(push) WARN_PRAGMA(ignored WARN_TOSTR(-W##x))
#define WARN_ON(x)                                                                                                     \
    WARN_PRAGMA(pop)                                                                                                   \
    WARN_PRAGMA(pop)
...
#define WARN_OFF(x)                                                                                                    \
    WARN_PRAGMA(push)                                                                                                  \
    WARN_PRAGMA(ignored "-Wunknown-warning-option") WARN_PRAGMA(push) WARN_PRAGMA(ignored WARN_TOSTR(-W##x))
#define WARN_ON(x)                                                                                                     \
    WARN_PRAGMA(pop)                                                                                                   \
    WARN_PRAGMA(pop)
#else
