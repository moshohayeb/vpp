...
#if BIHASH_32_64_SVM
    BV(clib_bihash_master_init_svm)(h, "test", user_buckets, 0x30000000 /* base_addr */, user_memory_size);
#else
...
#if BIHASH_32_64_SVM
    BV(clib_bihash_master_init_svm)(h, "test", tm->nbuckets, 0x30000000 /* base_addr */, tm->hash_memory_size);
#else
