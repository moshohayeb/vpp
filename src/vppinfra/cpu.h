...
#define foreach_march_variant(macro, x) macro(avx2, x, "arch=core-avx2")
#else
...
#define CLIB_MULTIARCH_SELECT_FN(fn, ...)                                                                              \
    ...
    {                                                                                                                  \
        foreach_march_variant(CLIB_MULTIARCH_ARCH_CHECK, fn) return &fn;                                               \
    }
...
{
    if ((AARCH64_CPU_IMPLEMENTER_QDF24XX == clib_cpu_implementer()) && (AARCH64_CPU_PART_QDF24XX == clib_cpu_part()))
        return 20;
    return -1;
}
...
{
    if ((AARCH64_CPU_IMPLEMENTER_CORTEXA72 == clib_cpu_implementer()) && (AARCH64_CPU_PART_CORTEXA72 == clib_cpu_part()))
        return 10;
    return -1;
}
...
#define CLIB_MARCH_FN(fn, rtype, _args...)                                                                             \
    ...
    static inline rtype CLIB_CPU_OPTIMIZED CLIB_MARCH_SFX(fn##_ma)(_args)
#else
#define CLIB_MARCH_FN(fn, rtype, _args...)                                                                             \
    static rtype CLIB_CPU_OPTIMIZED CLIB_MARCH_SFX(fn##_ma)(_args);                                                    \
