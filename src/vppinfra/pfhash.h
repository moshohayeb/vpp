...
void pfhash_init(pfhash_t *p, char *name, u32 key_size, u32 value_size, u32 nbuckets);
...
pfhash_search_kv_16(pfhash_t *p, u32 bucket_contents, u32x4 *key)
{
    ...
    rv = (is_equal0 & kv->values[0]) | (is_equal1 & kv->values[1]) | (is_equal2 & kv->values[2]) | no_match;
