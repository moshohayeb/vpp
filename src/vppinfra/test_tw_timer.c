...
test2_single(tw_timer_test_main_t *tm)
{
    ...
    for (i = 0; i < tm->ntimers; i++) {
        ...
        e->stop_timer_handle =
            tw_timer_start_2t_1w_2048sl(&tm->single_wheel, e - tm->test_elts, 1 /* timer id */, expiration_time);
    }
...
test2_double(tw_timer_test_main_t *tm)
{
    ...
    fformat(stdout, "initial wheel time %d, fast index %d slow index %d\n", tm->double_wheel.current_tick,
            tm->double_wheel.current_index[TW_TIMER_RING_FAST], tm->double_wheel.current_index[TW_TIMER_RING_SLOW]);
    ...
    for (i = 0; i < tm->ntimers; i++) {
        ...
        e->stop_timer_handle =
            tw_timer_start_16t_2w_512sl(&tm->double_wheel, e - tm->test_elts, 14 /* timer id */, expiration_time);
    }
...
test2_triple(tw_timer_test_main_t *tm)
{
    ...
    fformat(stdout, "initial wheel time %d, fi %d si %d gi %d\n", tm->triple_wheel.current_tick,
            tm->triple_wheel.current_index[TW_TIMER_RING_FAST], tm->triple_wheel.current_index[TW_TIMER_RING_SLOW],
    ...
    for (i = 0; i < tm->ntimers; i++) {
        ...
        e->stop_timer_handle =
            tw_timer_start_4t_3w_256sl(&tm->triple_wheel, e - tm->test_elts, 3 /* timer id */, expiration_time);
    }
...
test2_triple_ov(tw_timer_test_main_t *tm)
{
    ...
    tw_timer_wheel_init_1t_3w_1024sl_ov(&tm->triple_ov_wheel, expired_timer_triple_ov_callback,
    ...
    fformat(stdout, "initial wheel time %d, fi %d si %d gi %d\n", tm->triple_ov_wheel.current_tick,
            tm->triple_ov_wheel.current_index[TW_TIMER_RING_FAST], tm->triple_ov_wheel.current_index[TW_TIMER_RING_SLOW],
    ...
    for (i = 0; i < tm->ntimers; i++) {
        ...
        e->stop_timer_handle =
            tw_timer_start_1t_3w_1024sl_ov(&tm->triple_ov_wheel, e - tm->test_elts, 0 /* timer id */, expiration_time);
    }
    ...
    del_and_re_add:
        ...
        for (j = 0; j < tm->ntimers / 4; j++) {
            ...
            e->stop_timer_handle = tw_timer_start_1t_3w_1024sl_ov(&tm->triple_ov_wheel, e - tm->test_elts,
                                                                  0 /* timer id */, expiration_time);
        }
        adds += j;
    }
...
test1_single(tw_timer_test_main_t *tm)
{
    ...
    for (i = 0; i < tm->ntimers; i++) {
        ...
        e->stop_timer_handle =
            tw_timer_start_2t_1w_2048sl(&tm->single_wheel, e - tm->test_elts, 1 /* timer id */, timer_arg);
    }
...
test1_double(tw_timer_test_main_t *tm)
{
    ...
    for (i = 0; i < tm->ntimers; i++) {
        ...
        e->stop_timer_handle =
            tw_timer_start_16t_2w_512sl(&tm->double_wheel, e - tm->test_elts, 14 /* timer id */, i + 1);
    }
