...
typedef vlib_parse_match_t(vlib_parse_match_function_t)(struct vlib_parse_main *, struct vlib_parse_type *,
                                                        vlib_lex_token_t *, vlib_parse_value_t *);
...
#define _PARSE_TYPE_REGISTRATION_DATA(x)                                                                               \
    VLIB_ELF_SECTION_DATA(x##_type_registration, vlib_parse_type_t, parse_type_registrations)
