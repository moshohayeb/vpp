...
static u8 *
format_srv6_localsid_sample_trace(u8 *s, va_list *args)
{
...
srv6_localsid_sample_fn(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame)
{
    ...
    while (n_left_from > 0) {
        ...
        while (n_left_from > 0 && n_left_to_next > 0) {
            ...
            ip6_header_t *ip0 = 0;
            ip6_sr_header_t *sr0;
            ip6_ext_header_t *prev0 u32 next0 = SRV6_SAMPLE_LOCALSID_NEXT_IP6LOOKUP;
            ...
            vlib_increment_combined_counter(((next0 == SRV6_SAMPLE_LOCALSID_NEXT_ERROR) ? &(sm->sr_ls_invalid_counters) :
