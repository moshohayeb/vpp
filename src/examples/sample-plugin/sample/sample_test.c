 ...
 * we just generated
 */
#define foreach_vpe_api_reply_msg _(SAMPLE_MACSWAP_ENABLE_DISABLE_REPLY, sample_macswap_enable_disable_reply)


static int
api_sample_macswap_enable_disable(vat_main_t *vam)
{
 ...
 */
#define foreach_vpe_api_msg _(sample_macswap_enable_disable, "<intfc> [disable]")

static void
sample_api_hookup(vat_main_t *vam)
{
