...
int
sample_macswap_enable_disable(sample_main_t *sm, u32 sw_if_index, int enable_disable)
{
...
static clib_error_t *
macswap_enable_disable_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
 ...
 */
static void
vl_api_sample_macswap_enable_disable_t_handler(vl_api_sample_macswap_enable_disable_t *mp)
{
