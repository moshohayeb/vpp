...
static clib_error_t *
virtual_ip_cmd_fn_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    ...
    if (!unformat(line_input, "%U %U", unformat_ip4_address, &prefix.fp_addr.ip4, unformat_vnet_sw_interface, vnm,
                  &sw_if_index)) {
    ...
    fib_table_entry_path_add2(0,   // default FIB table
                              &prefix, FIB_SOURCE_CLI, FIB_ENTRY_FLAG_NONE, rpaths);
