...
maybe_register_api_client(vat_main_t *vam)
{
    ...
    *regpp  = clib_mem_alloc(sizeof(vl_api_registration_t));
    ...
    vam->my_client_index = vl_msg_api_handle_from_index_and_epoch(regp->vl_api_registration_pool_index,
...
static clib_error_t *
api_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    vat_main_t *vam = &vat_main;
