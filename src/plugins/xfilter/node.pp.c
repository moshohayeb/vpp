...
uword __attribute__((optimize("O3"))) xfilter_node_fn(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame)
{
    ...
    while (n_left_from > 0) {
        ...
        while (n_left_from >= 4 && n_left_to_next >= 2) {
            ...
            ;
            en0->src_address[0] = en0->dst_address[0];
            en0->src_address[1] = en0->dst_address[1];
            en0->src_address[2] = en0->dst_address[2];
            en0->src_address[3] = en0->dst_address[3];
            en0->src_address[4] = en0->dst_address[4];
            en0->src_address[5] = en0->dst_address[5];
            ;
            en0->dst_address[0] = tmp0[0];
            en0->dst_address[1] = tmp0[1];
            en0->dst_address[2] = tmp0[2];
            en0->dst_address[3] = tmp0[3];
            en0->dst_address[4] = tmp0[4];
            en0->dst_address[5] = tmp0[5];
            ;
            tmp1[0] = en1->src_address[0];
            tmp1[1] = en1->src_address[1];
            tmp1[2] = en1->src_address[2];
            tmp1[3] = en1->src_address[3];
            tmp1[4] = en1->src_address[4];
            tmp1[5] = en1->src_address[5];
            ;
            en1->src_address[0] = en1->dst_address[0];
            en1->src_address[1] = en1->dst_address[1];
            en1->src_address[2] = en1->dst_address[2];
            en1->src_address[3] = en1->dst_address[3];
            en1->src_address[4] = en1->dst_address[4];
            en1->src_address[5] = en1->dst_address[5];
            ;
            en1->dst_address[0] = tmp1[0];
            en1->dst_address[1] = tmp1[1];
            en1->dst_address[2] = tmp1[2];
            en1->dst_address[3] = tmp1[3];
            en1->dst_address[4] = tmp1[4];
            en1->dst_address[5] = tmp1[5];
            ;
            sw_if_index0 = ((vnet_buffer_opaque_t *) (b0)->opaque)->sw_if_index[VLIB_RX];
            sw_if_index1 = ((vnet_buffer_opaque_t *) (b1)->opaque)->sw_if_index[VLIB_RX];
            ((vnet_buffer_opaque_t *) (b0)->opaque)->sw_if_index[VLIB_TX] = sw_if_index0;
            ((vnet_buffer_opaque_t *) (b1)->opaque)->sw_if_index[VLIB_TX] = sw_if_index1;
            pkts_swapped += 2;
