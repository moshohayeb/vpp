...
#define lb_vip_is_ip4(type)                                                                                            \
    (type == LB_VIP_TYPE_IP4_GRE6 || type == LB_VIP_TYPE_IP4_GRE4 || type == LB_VIP_TYPE_IP4_L3DSR ||                  \
...
#define lb_encap_is_ip4(vip)                                                                                           \
    ((vip)->type == LB_VIP_TYPE_IP6_GRE4 || (vip)->type == LB_VIP_TYPE_IP4_GRE4 ||                                     \
     (vip)->type == LB_VIP_TYPE_IP4_L3DSR || (vip)->type == LB_VIP_TYPE_IP4_NAT4)

#define lb_vip_is_gre4(vip)                                                                                            \
    (((vip)->type == LB_VIP_TYPE_IP6_GRE4 || (vip)->type == LB_VIP_TYPE_IP4_GRE4) && ((vip)->port == 0))


#define lb_vip_is_gre6(vip)                                                                                            \
    (((vip)->type == LB_VIP_TYPE_IP6_GRE6 || (vip)->type == LB_VIP_TYPE_IP4_GRE6) && ((vip)->port == 0))
