...
always_inline void
vxlan_gpe_encap_ioam_v4_two_inline(vlib_main_t *vm, vlib_node_runtime_t *node, vxlan_gpe_main_t *ngm, vlib_buffer_t *b0,
...
static uword
vxlan_gpe_encap_ioam_v4(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *from_frame)
{
    ...
    while (n_left_from > 0) {
        ...
        while (n_left_from > 0 && n_left_to_next > 0) {
            ...
            vxlan_gpe_encap_decap_ioam_v4_one_inline(vm, node, b0, &next0, VXLAN_GPE_ENCAP_IOAM_V4_NEXT_DROP,
                                                     0 /* use_adj */);
