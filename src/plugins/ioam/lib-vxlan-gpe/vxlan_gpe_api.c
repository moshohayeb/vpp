...
static void
vl_api_vxlan_gpe_ioam_enable_t_handler(vl_api_vxlan_gpe_ioam_enable_t *mp)
{
    int rv = 0;
...
static void
vl_api_vxlan_gpe_ioam_disable_t_handler(vl_api_vxlan_gpe_ioam_disable_t *mp)
{
    int rv = 0;
...
static void
vl_api_vxlan_gpe_ioam_vni_enable_t_handler(vl_api_vxlan_gpe_ioam_vni_enable_t *mp)
{
    int rv = 0;
    ...
    error = vxlan_gpe_ioam_set(t, hm->has_trace_option, hm->has_pot_option, hm->has_ppc_option, mp->is_ipv6);
...
static void
vl_api_vxlan_gpe_ioam_vni_disable_t_handler(vl_api_vxlan_gpe_ioam_vni_disable_t *mp)
{
    int rv = 0;
    vl_api_vxlan_gpe_ioam_vni_enable_reply_t *rmp;
    clib_error_t *error;
...
static void
vl_api_vxlan_gpe_ioam_transit_enable_t_handler(vl_api_vxlan_gpe_ioam_transit_enable_t *mp)
{
    int rv = 0;
    ...
    rv = vxlan_gpe_enable_disable_ioam_for_dest(sm->vlib_main, dst_addr, ntohl(mp->outer_fib_index),
                                                mp->is_ipv6 ? 0 : 1, 1 /* is_add */);

    VXLAN_GPE_REPLY_MACRO(VL_API_VXLAN_GPE_IOAM_TRANSIT_ENABLE_REPLY);
}

static void
vl_api_vxlan_gpe_ioam_transit_disable_t_handler(vl_api_vxlan_gpe_ioam_transit_disable_t *mp)
{
    int rv = 0;
    ...
    rv = vxlan_gpe_ioam_disable_for_dest(sm->vlib_main, dst_addr, ntohl(mp->outer_fib_index), mp->is_ipv6 ? 0 : 1);
