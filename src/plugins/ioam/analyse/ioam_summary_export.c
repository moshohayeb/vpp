...
u8 *
ioam_template_rewrite(flow_report_main_t *frm, flow_report_t *fr, ip4_address_t *collector_address,
...
#undef _
    ...
    f->e_id_length = ipfix_e_id_length(0 /* enterprise */, ioamPathMap,
                                       (sizeof(ioam_path) + (sizeof(ioam_path_map_t) * IOAM_TRACE_MAX_NODES)));
    f++;
...
u16
ioam_analyse_add_ipfix_record(flow_report_t *fr, ioam_analyser_data_t *record, vlib_buffer_t *b0, u16 offset,
                              ip6_address_t *src, ip6_address_t *dst, u16 src_port, u16 dst_port)
{
...
vlib_frame_t *
ioam_send_flows(flow_report_main_t *frm, flow_report_t *fr, vlib_frame_t *f, u32 *to_next, u32 node_index)
{
