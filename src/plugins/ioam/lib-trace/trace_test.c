...
#define foreach_custom_reply_handler                                                                                   \
    _(trace_profile_show_config_reply, if (mp->trace_type) {                                                           \
...
#define foreach_vpe_api_msg                                                                                            \
    _(trace_profile_add, ""                                                                                            \
                         "trace-type <0x1f|0x3|0x9|0x11|0x19> trace-elts <nn> trace-tsp <0|1|2|3> node-id <node id "   \
                         "in hex> app-data <app_data in hex>")                                                         \
