...
int
vxlan_gpe_ioam_export_enable_disable(ioam_export_main_t *em, u8 is_disable, ip4_address_t *collector_address,
...
/* API message handler */
static void
vl_api_vxlan_gpe_ioam_export_enable_disable_t_handler(vl_api_vxlan_gpe_ioam_export_enable_disable_t *mp)
{
    vl_api_vxlan_gpe_ioam_export_enable_disable_reply_t *rmp;
    ioam_export_main_t *sm = &vxlan_gpe_ioam_export_main;
    int rv;

    rv = vxlan_gpe_ioam_export_enable_disable(sm, (int) (mp->is_disable), (ip4_address_t *) mp->collector_address,
...
static clib_error_t *
set_vxlan_gpe_ioam_export_ipfix_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    ...
    vlib_cli_output(vm, "Collector %U, src address %U", format_ip4_address, &em->ipfix_collector, format_ip4_address,
                    &em->src_address);
