...
#define foreach_custom_reply_retval_handler                                                                            \
    _(pot_profile_show_config_details, errmsg("		ID:%d\n", mp->id); errmsg("	 Validator:%d\n", mp->validator);      \
...
static int
api_pot_profile_add(vat_main_t *vam)
{
#define MAX_BITS 64
...
static int
api_pot_profile_activate(vat_main_t *vam)
{
#define MAX_BITS 64
    unformat_input_t *input = vam->input;
...
static int
api_pot_profile_del(vat_main_t *vam)
{
...
static int
api_pot_profile_show_config_dump(vat_main_t *vam)
{
    unformat_input_t *input = vam->input;
