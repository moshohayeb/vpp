...
static void
igmp_handle_group_update(igmp_config_t *config, const igmp_membership_group_v3_t *igmp_group)
{
    ...
    IGMP_DBG(" ..group-update: %U (%U, %U)", format_vnet_sw_if_index_name, vnet_get_main(), config->sw_if_index,
...
static void
igmp_handle_group_block(igmp_config_t *config, const igmp_membership_group_v3_t *igmp_group)
{
    ...
    IGMP_DBG(" ..group-block: %U (%U, %U)", format_vnet_sw_if_index_name, vnet_get_main(), config->sw_if_index,
             format_igmp_key, &key, format_igmp_src_addr_list, srcs);
...
static void
igmp_handle_group(igmp_config_t *config, const igmp_membership_group_v3_t *igmp_group)
{
