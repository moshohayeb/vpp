...
igmp_src_t *
igmp_group_src_update(igmp_group_t *group, const igmp_key_t *skey, igmp_mode_t mode)
{
    igmp_src_t *src;
...
igmp_group_clear(igmp_group_t *group)
{
    ...
    IGMP_DBG("clear-group: %U %U", format_igmp_key, group->key, format_vnet_sw_if_index_name, vnet_get_main(),
             config->sw_if_index);
...
igmp_group_t *
igmp_group_alloc(igmp_config_t *config, const igmp_key_t *gkey, igmp_filter_mode_t mode)
{
 ...
 */
ip46_address_t *
igmp_group_present_minus_new(igmp_group_t *group, igmp_filter_mode_t mode, const ip46_address_t *saddrs)
{
 ...
 */
ip46_address_t *
igmp_group_new_minus_present(igmp_group_t *group, igmp_filter_mode_t mode, const ip46_address_t *saddrs)
{
    const ip46_address_t *s1;
    ip46_address_t *npm;
    igmp_src_t *src;
...
ip46_address_t *
igmp_group_new_intersect_present(igmp_group_t *group, igmp_filter_mode_t mode, const ip46_address_t *saddrs)
{
