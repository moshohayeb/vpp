...
static walk_rc_t
svs_send_details(fib_protocol_t fproto, u32 table_id, u32 sw_if_index, void *args)
{
...
{
#define _(N, n)                                                                                                        \
    vl_msg_api_set_handlers((VL_API_##N + svs_base_msg_id), #n, vl_api_##n##_t_handler, vl_noop_handler,               \
...
{
#define _(id, n, crc) vl_msg_api_add_msg_name_crc(apim, #n "_" #crc, id + svs_base_msg_id);
...
svs_api_init(vlib_main_t *vm)
{
    ...
    svs_base_msg_id = vl_msg_api_get_msg_ids((char *) name, VL_MSG_FIRST_AVAILABLE);
