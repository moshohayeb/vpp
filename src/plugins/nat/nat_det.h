...
int snat_det_add_map(snat_main_t *sm, ip4_address_t *in_addr, u8 in_plen, ip4_address_t *out_addr, u8 out_plen,
                     int is_add);
...
always_inline void
snat_det_forward(snat_det_map_t *dm, ip4_address_t *in_addr, ip4_address_t *out_addr, u16 *lo_port)
{
...
always_inline void
snat_det_reverse(snat_det_map_t *dm, ip4_address_t *out_addr, u16 out_port, ip4_address_t *in_addr)
{
...
snat_det_get_ses_by_out(snat_det_map_t *dm, ip4_address_t *in_addr, u64 out_key)
{
    u32 user_offset;
    u16 i;
...
always_inline snat_det_session_t *
snat_det_find_ses_by_in(snat_det_map_t *dm, ip4_address_t *in_addr, u16 in_port, snat_det_out_key_t out_key)
{
...
always_inline snat_det_session_t *
snat_det_ses_create(snat_det_map_t *dm, ip4_address_t *in_addr, u16 in_port, snat_det_out_key_t *out)
{
    u32 user_offset;
    u16 i;
    ...
    snat_ipfix_logging_max_entries_per_user(SNAT_DET_SES_PER_USER, in_addr->as_u32);
    return 0;
}
