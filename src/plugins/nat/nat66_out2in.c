...
static inline uword
nat66_out2in_node_fn(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame)
{
    ...
    while (n_left_from > 0) {
        ...
        skip_csum0:
            ...
            vlib_increment_combined_counter(&nm->session_counters, thread_index, sm0 - nm->sm, 1,
    ...
    vlib_node_increment_counter(vm, nat66_out2in_node.index, NAT66_OUT2IN_ERROR_OUT2IN_PACKETS, pkts_processed);
