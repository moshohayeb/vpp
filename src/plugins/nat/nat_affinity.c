...
format_affinity_kvp(u8 *s, va_list *args)
{
    ...
    s = format(s, "client %U backend %U:%d proto %U index %llu", format_ip4_address, &k.client_addr, format_ip4_address,
               &k.service_addr, clib_net_to_host_u16(k.service_port), format_snat_protocol, k.proto);
...
make_affinity_kv(clib_bihash_kv_16_8_t *kv, ip4_address_t client_addr, ip4_address_t service_addr, u8 proto,
                 u16 service_port)
{
...
int
nat_affinity_find_and_lock(ip4_address_t client_addr, ip4_address_t service_addr, u8 proto, u16 service_port,
                           u8 *backend_index)
{
    nat_affinity_main_t *nam = &nat_affinity_main;
...
int
nat_affinity_create_and_lock(ip4_address_t client_addr, ip4_address_t service_addr, u8 proto, u16 service_port,
                             u8 backend_index, u32 sticky_time, u32 affinity_per_service_list_head_index)
{
    nat_affinity_main_t *nam = &nat_affinity_main;
    clib_bihash_kv_16_8_t kv, value;
    nat_affinity_t *a;
...
void
nat_affinity_unlock(ip4_address_t client_addr, ip4_address_t service_addr, u8 proto, u16 service_port)
{
    nat_affinity_main_t *nam = &nat_affinity_main;
    clib_bihash_kv_16_8_t kv, value;
    nat_affinity_t *a;
