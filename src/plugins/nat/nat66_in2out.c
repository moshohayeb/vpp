...
static inline uword
nat66_in2out_node_fn(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame)
{
    ...
    vlib_node_increment_counter(vm, nat66_in2out_node.index, NAT66_IN2OUT_ERROR_IN2OUT_PACKETS, pkts_processed);
