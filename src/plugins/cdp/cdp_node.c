    ...
    while (1) {
        ...
        case CDP_EVENT_ENABLE:
            if (!cm->cdp_protocol_registered) {
                 ...
                 */
                snap_register_input_protocol(vm, "cdp-input", 0xC /* ieee_oui, Cisco */, 0x2000 /* protocol CDP */,
                                             cdp_input_node.index);

                snap_register_input_protocol(vm, "cdp-input", 0xC /* ieee_oui, Cisco */, 0x2004 /* protocol CDP */,
                                             cdp_input_node.index);
#if 0
	      /*
