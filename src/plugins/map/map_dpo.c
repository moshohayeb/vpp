...
void
map_dpo_create(dpo_proto_t dproto, u32 domain_index, dpo_id_t *dpo)
{
    dpo_set(dpo, map_dpo_type, dproto, domain_index);
}

void
map_t_dpo_create(dpo_proto_t dproto, u32 domain_index, dpo_id_t *dpo)
{
    dpo_set(dpo, map_t_dpo_type, dproto, domain_index);
}
