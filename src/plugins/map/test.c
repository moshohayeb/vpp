...
static map_domain_t *
get_domain(ip4_address_t *ip4_prefix, u8 ip4_prefix_len, ip6_address_t *ip6_prefix, u8 ip6_prefix_len,
           ip6_address_t *ip6_src, u8 ip6_src_len, u8 ea_bits_len, u8 psid_offset, u8 psid_length, u16 mtu, u8 flags)
{
...
/*
 * VPP-340:
 * map_add_domain ip4-pfx 20.0.0.0/8 ip6-pfx 2001:db8::/40 ip6-src 2001:db8:ffff::/96 ea-bits-len 24 psid-offset 0
 * psid-len 0 map-t IPv4 src = 100.0.0.1 IPv4 dst = 20.169.201.219 UDP dest port = 1232 IPv6 src = 2001:db8:ffff::6400:1
