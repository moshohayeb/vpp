...
#undef _
    ...
    lacp_state_struct *state_entry = (lacp_state_struct *) &lacp_rx_sm_state_array;
...
#undef _
        {.str = NULL}};
    int state                      = va_arg(*args, int);
    lacp_state_struct *state_entry = (lacp_state_struct *) &lacp_tx_sm_state_array;
...
#undef _
        {.str = NULL}};
    int state                      = va_arg(*args, int);
    lacp_state_struct *state_entry = (lacp_state_struct *) &lacp_mux_sm_state_array;
...
#undef _
        {.str = NULL}};
    int state                      = va_arg(*args, int);
    lacp_state_struct *state_entry = (lacp_state_struct *) &lacp_ptx_sm_state_array;
