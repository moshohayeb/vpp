...
test_bihash_threads(bihash_test_main_t *tm)
{
    ...
    clib_warning("%lld items in %.2f seconds, %.2f items/sec", (u64) tm->nthreads * (u64) tm->nitems, delta,
...
static clib_error_t *
test_bihash_command_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    bihash_test_main_t *tm = &bihash_test_main;
    clib_error_t *error;
    int which = 0;
