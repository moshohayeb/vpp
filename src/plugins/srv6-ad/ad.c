...
srv6_ad_init(vlib_main_t *vm)
{
    ...
    rv = sr_localsid_register_function(vm, function_name, keyword_str, def_str, params_str, &sm->srv6_ad_dpo_type,
                                       format_srv6_ad_localsid, unformat_srv6_ad_localsid, srv6_ad_localsid_creation_fn,
