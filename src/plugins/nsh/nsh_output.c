...
format_nsh_output_trace(u8 *s, va_list *args)
{
    ...
    s = format(s, "adj-idx %d : %U flow hash: 0x%08x", t->adj_index, format_ip_adjacency, t->adj_index,
...
static inline uword
nsh_output_inline(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *from_frame, int is_midchain)
{
...
static inline uword
nsh_eth_output(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *from_frame)
{
...
static inline uword
nsh_midchain(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *from_frame)
{
 ...
 */
static inline uword
nsh_adj_incomplete(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *from_frame)
{
...
VLIB_NODE_FUNCTION_MULTIARCH(nsh_adj_incomplete_node, nsh_adj_incomplete)
