...
int
nsh_md2_ioam_trace_swap_handler(vlib_buffer_t *b, nsh_tlv_header_t *old_opt, nsh_tlv_header_t *new_opt)
{
...
static clib_error_t *
nsh_md2_ioam_show_ioam_trace_cmd_fn(vlib_main_t *vm, unformat_input_t *input, vlib_cli_command_t *cmd)
{
    nsh_md2_ioam_trace_main_t *hm = &nsh_md2_ioam_trace_main;
    u8 *s                         = 0;
    int i                         = 0;
...
nsh_md2_ioam_trace_init(vlib_main_t *vm)
{
    ...
    if (nsh_md2_register_option(clib_host_to_net_u16(0x9), NSH_MD2_IOAM_OPTION_TYPE_TRACE,
                                ...
                                nsh_md2_ioam_trace_pop_handler, nsh_md2_ioam_trace_data_list_trace_handler) < 0)
