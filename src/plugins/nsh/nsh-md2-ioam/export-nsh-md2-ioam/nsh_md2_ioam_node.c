...
static void
nsh_md2_ioam_export_fixup_func(vlib_buffer_t *export_buf, vlib_buffer_t *pak_buf)
{
    /* Todo: on implementing analyse */
}

static uword
nsh_md2_ioam_export_node_fn(vlib_main_t *vm, vlib_node_runtime_t *node, vlib_frame_t *frame)
{
    ioam_export_main_t *em = &nsh_md2_ioam_export_main;
    ioam_export_node_common(em, vm, node, frame, ip4_header_t, length, ip_version_and_header_length,
