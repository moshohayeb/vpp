...
#define elog_acl_cond_trace_X2(am, trace_cond, acl_elog_trace_format_label, acl_elog_trace_format_args, acl_elog_val1, \
                               acl_elog_val2)                                                                          \
    do {                                                                                                               \
        if (trace_cond) {                                                                                              \
...
/* use like: elog_acl_cond_trace_X4(am, (x<0), "foobar: %d some int %d baz: %d bar: %d", "i4i4i4i4", int32_value,
