...
{
#define _(id, n, crc) vl_msg_api_add_msg_name_crc(am, #n "_" #crc, id + L2E_MSG_BASE);
...
{
#define _(N, n)                                                                                                        \
    vl_msg_api_set_handlers(VL_API_##N + L2E_MSG_BASE, #n, vl_api_##n##_t_handler, vl_noop_handler,                    \
...
l2e_init(vlib_main_t *vm)
{
    ...
    l2em->msg_id_base = vl_msg_api_get_msg_ids((char *) name, VL_MSG_FIRST_AVAILABLE);
