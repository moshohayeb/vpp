...
void
compute_state_statistics(int verbose, FILE *ofp)
{
    int i, j;
    bound_track_t *bp;
    f64 fticks;
...
int
track_compare_max(const void *arg1, const void *arg2)
{
...
int
track_compare_occurrences(const void *arg1, const void *arg2)
{
    bound_track_t *a1 = (bound_track_t *) arg1;
    bound_track_t *a2 = (bound_track_t *) arg2;
    f64 v1, v2;
...
int
track_compare_name(const void *arg1, const void *arg2)
{
    bound_track_t *a1 = (bound_track_t *) arg1;
    bound_track_t *a2 = (bound_track_t *) arg2;
...
void
sort_state_statistics(sort_t type, FILE *ofp)
{
...
void
print_state_statistics(int verbose, FILE *ofp)
{
    int i, j;
    u8 *trackpad;
    bound_track_t *bp;
    ...
    for (i = 0; i < vec_len(bound_tracks); i++) {
        ...
        if (name_filter && strncmp((char *) bp->track_str, (char *) name_filter, strlen((char *) name_filter)))
            continue;
         ...
         * state statistics
         */
        if (exclude_kernel_from_summary_stats && !strncmp((char *) bp->track_str, "kernel ", 7))
            continue;
        ...
        if (!summary_stats_only) {
            ...
            fprintf(ofp, "%10.3f +- %10.3f", bp->mean_ticks_in_state / ticks_per_us,
                    sqrt(bp->variance_ticks_in_state) / ticks_per_us);
    ...
    if (name_filter)
        fprintf(ofp, "Note: only pid/proc/threads matching '%s' are included.\n", name_filter);

    fprintf(ofp, "Total time in state: %10.3f (us), Total state occurrences: %.0f\n", total_time / ticks_per_us,
            total_switches);
